...
/*
	...
	2. in func main print out the values for each identifier

	3. The compiler assigned values to the variables. What are these values called?
*/
...
// The compiler assigned values when I declared these variables. These values are called zero values.